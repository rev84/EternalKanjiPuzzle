...
define('API_KEY', 'AIzaSyCXEZqFWsMtLV6mAWhge5Ktkpb9Yrfx3Xg');
define('ENGINE_KEY', '007439105848838967886:66rpndjrqvo');
...
foreach ($gen as $r) {
    ...
    $url = 'https://www.googleapis.com/customsearch/v1?key='.API_KEY.'&cx='.ENGINE_KEY.'&q="'.$word.'"';
